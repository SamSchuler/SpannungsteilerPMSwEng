...
void MainWindow::calculate(int u1, int u2, int reihe)
{
  ...
  if (reihe == 1)
  {
    /* ereihe[27] = {1,         2.2,       4.7,      10,       22,       47,
                100,       220,       470,      1000,     2200,     4700,
                10000,     22000,     47000,    100000,   220000,   470000,
                1000000,   2200000,   4700000,  10000000, 22000000, 47000000,
                100000000, 220000000, 470000000};
*/  // E3
    anzereihe = 27;
  }
  ...
  // Verhältnis suchen
  for (int i = 0; i < anzereihe; ++i)
  {
    for (int j = 0; j < anzereihe; ++j)
    {
